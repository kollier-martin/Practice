package TheRealmofYor.Main;

import TheRealmofYor.Commands.*;
import TheRealmofYor.Assets.*;
import java.util.*;
...
public class Game 
{
	...
	public static void createArtifacts()
	{
		...
		artifacts.add(new Artifact(rand.nextInt(50), "Yör's Garmet", ", Yör's bath robe but what is this?"
    ...
    {	
        ...
        newNum = rand.nextInt(artifacts.size());
        Room Throne = new Room("throne room of Yör", artifacts.get(newNum));
        artifacts.remove(newNum);
	...
	{
		//Create an ASCII art
		System.out.print("Welcome to 'The Realm of Yõr' this is a demo. The full game will be completed without an ETA."
				+ " All suggestions are welcome .\n");
		System.out.print("Here is the list of commands: "); listOf.printAll();
			...
			while( true )
			{
					...
					if( answer.equalsIgnoreCase("yes") || answer.equalsIgnoreCase("y"))
					{
						...
						if(sequence.battle(Game.player, gair))
						{
							...
							System.out.println("Yör: NO! Gair don't do it");
						...
						{
							System.out.println(gair.getName() + ": *LAUGHING* Yör! This is your champion? You two are pitiful.\nGair grabs you"
									+ " off of the ground and walks over to Yör, stunned, he watches as Gair dissolves you with"
